...
public final class Geth {
    ...
    public func getTransactions(address: String,
                                sort: Etherscan.GetTransactions.Sort = .des,
                                startBlock: Int64 = 0,
                                endBlock: Int64 = 99999999,
                                completionHandler: @escaping (Result<Transactions>) -> Void) {
    ...
    public func getTokenTransactions(address: String, completionHandler: @escaping (Result<Transactions>) -> Void) {
