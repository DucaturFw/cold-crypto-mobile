...
public final class Wallet {
    ...
    public init(seed: Data, index: UInt32, network: Network, debugPrints: Bool) throws {
        self.network = network
        self.debugPrints = debugPrints

        var tmp = try HDPrivateKey(seed: seed, network: network)
